                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                            ...
                            <div class="relative">
                                ...
                                <button type="button" id="scan-barcode-btn"
                                    class="absolute right-3 top-3.5 h-5 w-5 text-gray-400 hover:text-purple-500 transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                                    disabled title="{{ __('dashboard.Scan with camera') }}">

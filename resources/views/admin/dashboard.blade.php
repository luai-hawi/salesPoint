    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                ...
                <div class="bg-white shadow-lg rounded-xl overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200">
                        <h3 class="text-lg font-semibold text-gray-900">{{ __('messages.Top Performers This Month') }}</h3>
                    </div>
                    <div class="p-6">
                            ...
                            <div class="flex items-center justify-between py-3 {{ !$loop->last ? 'border-b border-gray-100' : '' }}">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3">
                                        ...
                                        <p class="text-xs text-gray-500">{{ $shopOwner->employees_count }} {{ __('messages.employees') }}</p>
                                    </div>
                                </div>
            ...
            <div class="bg-white shadow-lg rounded-xl overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-gray-900">{{ __('messages.Shop Owners Management') }}</h3>
                        <a href="{{ route('admin.shop-owners.create') }}" 
                           class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('messages.Employees') }}</th>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('messages.Sales This Month') }}</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($shopOwners as $shopOwner)
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">${{ number_format($shopOwner->sales_this_month, 2) }}</div>
                                        <div class="text-sm text-gray-500">{{ $shopOwner->products_count }} {{ __('messages.Products') }}, {{ $shopOwner->customers_count }} {{ __('messages.Customers') }}</div>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="5" class="px-6 py-12 text-center">
                                        <div class="text-gray-500">
                                            ...
                                            <p class="text-lg font-medium">{{ __('messages.No shop owners found') }}</p>
                                            <p class="text-sm text-gray-400 mt-1">{{ __('messages.Get started by creating your first shop owner') }}</p>
                                            <a href="{{ route('admin.shop-owners.create') }}" 

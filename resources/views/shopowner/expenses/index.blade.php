        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
                <div class="text-sm text-gray-600 bg-gray-100 px-4 py-2 rounded-full">
                    {{ __('expenses.Total Expenses') }}: <span
                        class="font-bold text-blue-600">{{ $expenses->total() }}</span>
                </div>
                @if (request('from') || request('to'))
                    <div class="text-sm text-gray-600 bg-blue-100 px-4 py-2 rounded-full">
                        Filtered: <span class="font-bold text-blue-600">
                            @if (request('from') && request('to'))
                                {{ \Carbon\Carbon::parse(request('from'))->format('M d') }} -
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-8 overflow-hidden">
                ...
                <form method="GET" action="{{ route('shopowner.expenses.index') }}" class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                        <div>
                            <label
                                class="block text-sm font-medium text-gray-700 mb-2">{{ __('expenses.From Date') }}</label>
                        ...
                        <div>
                            <label
                                class="block text-sm font-medium text-gray-700 mb-2">{{ __('expenses.To Date') }}</label>
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">
                                <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M8 7V3a4 4 0 118 0v4m-4 0v8m0 0l3-3m-3 3l-3-3"></path>
                                </svg>
                                {{ __('expenses.Date') }}
                            </label>
                            ...
                            @forelse($expenses as $expense)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <form action="{{ route('shopowner.expenses.destroy', $expense) }}"
                                            method="POST"
                                    ...
                                    <td colspan="5" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <h3 class="text-lg font-medium text-gray-900 mb-2">
                                                {{ __('expenses.No expenses found') }}</h3>
                                            <p class="text-gray-500">
                                                {{ __('expenses.Start by adding your first expense above.') }}</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse

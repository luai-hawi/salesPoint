        ...
        <div class="flex-wrap gap-4 items-center justify-between">
            ...
            <div class="flex flex-wrap gap-4 items-center space-x-4">
                ...
                <a href="{{ route('shopowner.employees.create') }}"
                    class="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-6 py-2 rounded-lg shadow-md transition-all duration-200 transform hover:scale-105 flex items-center flex-wrap">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-2xl font-bold text-gray-900">
                                    ₪{{ number_format($employees->sum('monthly_salary'), 2) }}</p>
                    ...
                    <div class="bg-white overflow-hidden shadow-lg rounded-xl p-6 border-l-4 border-orange-500">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-2xl font-bold text-gray-900">
                                    ₪{{ number_format($employees->sum(function ($emp) {return $emp->paidThisMonth();}),2) }}
                                </p>
                    ...
                    <div class="bg-white overflow-hidden shadow-lg rounded-xl p-6 border-l-4 border-red-500">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-2xl font-bold text-gray-900">
                                    ₪{{ number_format($employees->sum(function ($emp) {return $emp->remainingThisMonth();}),2) }}
                                </p>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach ($employees as $employee)
                                    @php
                                        ...
                                        $percentage =
                                            $employee->monthly_salary > 0
                                                ? ($paid / $employee->monthly_salary) * 100
                                                : 0;
                                    @endphp
                                    <tr class="hover:bg-gray-50 transition-colors duration-200">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-12 w-12">
                                                    <div
                                                        class="h-12 w-12 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center">
                                                        <span
                                                            class="text-lg font-bold text-white">{{ substr($employee->name, 0, 1) }}</span>
                                                    </div>
                                                </div>
                                                <div class="ml-4">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div
                                                class="text-sm font-semibold {{ $remaining > 0 ? 'text-orange-600' : 'text-green-600' }}">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <form
                                                    action="{{ route('shopowner.employees.destroy', $employee->id) }}"
            ...
            @else
                ...
                <div class="bg-white shadow-xl rounded-xl overflow-hidden">
                    <div class="text-center py-16">
                        ...
                        <h3 class="text-2xl font-semibold text-gray-900 mb-4">{{ __('employees.No employees found') }}
                        </h3>

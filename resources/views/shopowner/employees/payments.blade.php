...
<x-app-layout>
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex-wrap gap-4 items-center space-x-4">
                ...
                <div class="text-sm text-gray-600 bg-blue-100 px-4 py-2 rounded-full">
                    {{ __('employees.Job Title') }}: <span
                        class="font-bold text-blue-600">{{ $employee->job_title }}</span>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-2xl font-bold text-gray-900">
                                ₪{{ number_format($employee->monthly_salary, 2) }}</p>
                ...
                <div class="bg-white overflow-hidden shadow-lg rounded-xl p-6 border-l-4 border-green-500">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-2xl font-bold text-gray-900">
                                ₪{{ number_format($employee->paidThisMonth(), 2) }}</p>
                ...
                <div class="bg-white overflow-hidden shadow-lg rounded-xl p-6 border-l-4 border-orange-500">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-2xl font-bold text-gray-900">
                                ₪{{ number_format($employee->remainingThisMonth(), 2) }}</p>
                            ...
                            @php
                                $percentage =
                                    $employee->monthly_salary > 0
                                        ? ($employee->paidThisMonth() / $employee->monthly_salary) * 100
                                        : 0;
                            @endphp
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white shadow-xl rounded-xl overflow-hidden">
                        ...
                        <div class="p-6">
                            <form action="{{ route('shopowner.employees.storePayment', $employee->id) }}"
                                ...
                                <div>
                                    ...
                                    @if ($employee->remainingThisMonth() > 0)
                                        <p class="mt-1 text-sm text-gray-600">
                                            {{ __('employees.Suggested') }}:
                                            ${{ number_format($employee->remainingThisMonth(), 2) }}
                                        </p>
                                    @endif
                                    @error('amount')
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white shadow-xl rounded-xl overflow-hidden">
                        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                            <div class="flex items-center justify-between">
                                <h3 class="text-lg font-semibold text-gray-900">{{ __('employees.Payment History') }}
                                </h3>

                                <!-- Date Filter -->
                                <form id="filter-form" class="flex-wrap gap-4 space-x-3">
                                    <div>
                        ...
                        <div id="payments-container">
                            @include('shopowner.employees.partials.payments_table', [
                                'payments' => $payments,
                            ])
                        </div>
    ...
    <script>
            ...
            fetch("{{ route('shopowner.employees.payments', $employee->id) }}?" + params.toString(), {
                ...
                .then(html => {
                    ...
                    if (reset) {
                        ...
                        if (newRows) {
                            document.querySelector('#payments-container tbody').insertAdjacentHTML('beforeend', newRows
                                .innerHTML);
                        }
        ...
        document.querySelector('form[action*="storePayment"]').addEventListener('submit', function(e) {
            ...
            if (amount > maxAmount) {
                if (!confirm(
                        `{{ __('employees.Payment amount exceeds monthly salary. Are you sure you want to continue?') }}`
                    )) {
                    e.preventDefault();
                    return;
                }

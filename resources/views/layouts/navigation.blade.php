        ...
        <div class="h-full overflow-y-auto overflow-x-hidden py-2"
            ...
            @if (Auth::user()->role === 'admin')
                ...
                <div @mouseenter="showTip($event, @js(__('navigation.License Monitor')))" @mouseleave="hideTip()"
                    class="relative px-2 mb-0.5">
                    <a href="{{ route('admin.shop-owners.expiring-licenses') }}"
                        class="{{ $navLink }} {{ $ac }}">
                        <div class="relative flex-shrink-0">
                            ...
                            @if ($expiredLicenseCount > 0)
                                <span
                                    class="absolute -top-1 -right-1 inline-flex items-center justify-center min-w-[16px] h-4 px-0.5 bg-red-600 text-white text-[10px] font-bold rounded-full leading-none">
                        ...
                        <span x-cloak x-show="$store.sidebar.expanded"
                            ...
                            @if ($expiredLicenseCount > 0)
                                <span
                                    class="inline-flex items-center justify-center min-w-[18px] h-[18px] px-1 bg-red-600 text-white text-xs font-bold rounded-full leading-none">
                                    {{ $expiredLicenseCount > 99 ? '99+' : $expiredLicenseCount }}
                                </span>
                            @endif
                        </span>

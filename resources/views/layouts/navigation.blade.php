                                            ...
                                            <div class="px-4 py-2 border-t border-gray-100">
                                                ...
                                                @if (auth()->user()->role !== 'employee' || auth()->user()->hasPermission('manage_payments_receipts'))
                                                    <a href="{{ route('payments-receipts.index') }}"
                                                        class="flex items-center p-2 rounded-md hover:bg-gray-50 transition-colors duration-200 {{ request()->routeIs('payments-receipts.*') ? 'bg-gray-50 text-gray-900' : 'text-gray-700' }}">
                                                        <svg class="w-4 h-4 mr-3 text-purple-600" fill="none"
                                                            stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                                stroke-width="2"

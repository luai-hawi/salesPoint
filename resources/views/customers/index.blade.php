        ...
        <div class="flex-wrap gap-4 items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
                <div class="text-sm text-gray-600 bg-gray-100 px-4 py-2 rounded-full">
                    {{ __('messages.Total Customers') }}: <span
                        class="font-bold text-blue-600">{{ $customers->total() }}</span>
                </div>
            ...
            <div class="bg-gradient-to-br from-green-400 to-green-600 rounded-xl p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold">
                            {{ $customers->where('updated_at', '>=', now()->startOfDay())->count() }}</p>
                    </div>
                        ...
                        @forelse ($customers as $customer)
                            <tr class="hover:bg-gray-50 transition-colors duration-150"
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    ...
                                    <div class="text-xs text-gray-400">{{ $customer->updated_at->format('H:i') }}
                                    </div>
                                </td>
                                ...
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <h3 class="text-lg font-medium text-gray-900 mb-1">
                                            {{ __('messages.No customers found') }}</h3>
                                        <p class="text-gray-500">
                                            {{ __('messages.Start by adding your first customer.') }}</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse

...
<x-slot name="header">
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-4">
            <div class="text-sm text-gray-600 bg-gray-100 px-4 py-2 rounded-full">
                {{ __('messages.Mode') }}: <span class="font-bold text-green-600">{{ __('Create') }}</span>
            </div>
            ...
            <div class="flex items-center justify-center">
                <div class="flex items-center space-x-4">
                    <div class="flex items-center space-x-2">
                        ...
                        <span class="text-sm font-medium text-blue-600">{{ __('messages.Customer Details') }}</span>
                    </div>
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <span class="text-sm font-medium text-gray-500">{{ __('messages.Save Customer') }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-8">
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-semibold text-white">{{ __('messages.Create Customer Profile') }}</h3>
                    <p class="text-blue-100 text-sm mt-1">{{ __('messages.Enter customer information to get started') }}</p>
                </div>
            </div>
                ...
                <form action="{{ route('customers.store') }}" method="POST" class="space-y-6" id="customer-form">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               placeholder="{{ __('messages.Enter customer\'s full name') }}"
                               required>
                        @error('name')
                    ...
                    <div>
                        ...
                        <input type="tel" 
                               ...
                               placeholder="{{ __('messages.Enter phone number (optional)') }}">
                        @error('phone')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">{{ __('messages.Phone number is optional but recommended for better customer service') }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" 
                                   ...
                                   placeholder="{{ __('messages.Enter initial balance') }}">
                        </div>
                        <p class="mt-1 text-xs text-gray-500">
                            {{ __('messages.Set positive for credit, negative for debt. Leave as 0 for new customers.') }}
                        </p>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:space-x-4 space-y-3 sm:space-y-0 pt-6">
                        ...
                        <button type="submit" 
                            ...
                            <span id="submit-text">{{ __('messages.Create Customer') }}</span>
        ...
        <div class="mt-8 bg-blue-50 rounded-lg p-6">
            ...
            <ul class="text-sm text-blue-700 space-y-2">
                <li class="flex items-start">
                    ...
                    {{ __('messages.Customer names should be unique and easily recognizable') }}
                </li>
                <li class="flex items-start">
                    <svg class="w-4 h-4 mr-2 mt-0.5 text-blue-500" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                    </svg>
                    {{ __('messages.Phone numbers help with order confirmations and follow-ups') }}
                </li>
                <li class="flex items-start">
                    <svg class="w-4 h-4 mr-2 mt-0.5 text-blue-500" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                    </svg>
                    {{ __('messages.You can always edit customer information later') }}
                </li>
            </ul>
        </div>
    </div>
    ...
    <script>
        ...
        document.getElementById('customer-form').addEventListener('submit', function() {
            ...
            submitText.textContent = '{{ __('messages.Creating...') }}';

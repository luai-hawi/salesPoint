                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-6">
                        <div class="flex items-center">
                            <div
                                class="h-12 w-12 bg-white bg-opacity-20 rounded-full flex items-center justify-center text-white font-bold text-lg mr-4">
                    ...
                    <div class="p-6">
                                ...
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        <h3 class="text-sm font-medium text-red-800">
                                            {{ __('messages.Please fix the following errors:') }}</h3>
                        ...
                        <form method="POST" action="{{ route('customers.update', $customer) }}" class="space-y-6">
                            ...
                            <!-- Action Buttons -->
                            <div
                                class="flex flex-col sm:flex-row sm:justify-between sm:space-x-4 space-y-3 sm:space-y-0 pt-6">
                                <a href="{{ route('customers.index') }}"
                ...
                <div class="bg-white rounded-xl shadow-lg p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span
                                class="text-sm font-medium text-gray-900">{{ $customer->created_at->format('M d, Y') }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-sm text-gray-500">{{ __('messages.Last Updated') }}:</span>
                            <span
                                class="text-sm font-medium text-gray-900">{{ $customer->updated_at->format('M d, Y') }}</span>
                        </div>
                    </div>
                </div>

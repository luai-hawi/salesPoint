    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-4">
            <div class="text-sm text-gray-600 bg-gray-100 px-4 py-2 rounded-full">
                Editing: <span class="font-bold text-orange-600">{{ $customer->name }}</span>
            </div>
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-6">
                        <div class="flex items-center">
                            ...
                            <div>
                                <h3 class="text-lg font-semibold text-white">Customer Profile</h3>
                                <p class="text-blue-100 text-sm">Update customer information</p>
                            </div>
                        </div>
                    </div>
